...
type AuditAndAccountability struct {
	FetchWazuhLogs              func() (WazuhResponse, error)
	CheckSystemClockSyncWithNTP func(string) (bool, error)
}

func NewAuditAndAccountability() *AuditAndAccountability {
	return &AuditAndAccountability{
		FetchWazuhLogs:              defaultFetchWazuhLogs,
		CheckSystemClockSyncWithNTP: defaultCheckSystemClockSyncWithNTP,
	}
}

func defaultFetchWazuhLogs() (WazuhResponse, error) {
...
func defaultCheckSystemClockSyncWithNTP(ntpServer string) (bool, error) {
...
func (a *AuditAndAccountability) checkLoggingProcess() error {
